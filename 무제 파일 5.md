...
#[JPA] 
조인 관련 옵션@ManyToOne(fetch = FetchType.LAZY, optional = false)@JoinColumn(name = "", nullable = false, columnDefinition = "")@OneToMany(mappedBy = “”, fetch = FetchType.LAZY, cascade = CascadeType.ALL, orphanRemoval = true)@OneToOne(fetch = FetchType.LAZY, cascade = CascadeType.ALL, orphanRemoval = true)‣ @ManyToOne과 @JoinColumn 관계[https://hyeon9mak.github.io/omit-join-column-when-using-many-to-one/‣](https://hyeon9mak.github.io/omit-join-column-when-using-many-to-one/%E2%80%A3) @OneToOne(fetch = FetchType.LAZY) 설정됐을 때 발생하는 이슈[https://1-7171771.tistory.com/143‣](https://1-7171771.tistory.com/143%E2%80%A3) 양방향 연관관계[https://velog.io/@dhk22/JPA-%EC%96%91%EB%B0%A9%ED%96%A5-%EC%97%B0%EA%B4%80%EA%B4%80%EA%B3%84‣](https://velog.io/@dhk22/JPA-%EC%96%91%EB%B0%A9%ED%96%A5-%EC%97%B0%EA%B4%80%EA%B4%80%EA%B3%84%E2%80%A3) 엔티티 연관관계 매핑 정리[https://cjw-awdsd.tistory.com/47](https://cjw-awdsd.tistory.com/47)